...
///Abstract system of particles in 3-D space, I guess.
///If one needs time, just stuff it into a Vector3f.
///Importantly, forces are accomodated by storing velocities
///as Vector3f's.
